...
public class MainUI {
	...
	/**
	 * Value to show if user is logged in. Initialized to false, for security.
	 */
	private static boolean loggedIn = false;

	/**
	 * Value to show if user is an administrator Initialized to false, for
	 * security.
	 */
	 ...
	 * 
	 * @param pane
	 *            - <code>Container</code> the components are being added to.
	...
	public static void addComponentsToPane(Container pane) {
		 ...
		 * |status | |-------------| |addFamily | |-------------| |scrollpane |
		 * +-------------+
		 */
		// Standard padding for the elements
		int padding = 5;
		// constraints on the placement of the status bar
		layout.putConstraint(SpringLayout.WEST, status, padding,
				SpringLayout.WEST, pane);
		layout.putConstraint(SpringLayout.NORTH, status, padding,
				SpringLayout.NORTH, pane);
		// constraints on the addFamilyPane
		layout.putConstraint(SpringLayout.WEST, addFamily, padding,
				SpringLayout.WEST, pane);
		layout.putConstraint(SpringLayout.NORTH, addFamily, padding,
	...
	/**
	 * Create a status pane that displays the following -"Add Family to List"
	 * button
	 */
