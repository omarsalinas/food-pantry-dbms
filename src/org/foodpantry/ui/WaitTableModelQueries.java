...
public class WaitTableModelQueries {
	...
	/**
	 * If check is true enter station into Station_Record, if false, then delete
	 * record from Station_Record;
	 * 
	 * @param familyName
	 * @param Station
	 * @param date
	 * @param check
	 */
	public void updateStationRecord(int familyNumber, String station,
			Date date, Boolean check) {
	 ...
	 * @throws SQLException
	 */
	public List<String> getStationsFamilyVisit(Date date, int familyNumber)
			throws SQLException {
